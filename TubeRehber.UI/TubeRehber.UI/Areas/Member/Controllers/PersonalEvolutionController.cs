...
{
    public class PersonalEvolutionController : BaseController
    {
       ...
       new readonly MemberService _memberService;
        ...
        public PersonalEvolutionController()
        {
        ...
        public ActionResult Index()
        {
            ...
            TubeRehber.Model.Entities.Category category = _categoryService.GetCategoryByCategoryName("Kişisel Gelişim");
            ...
            TempData["PersonalEvolutionChannelLinks"] = ChannelLinks;
