...
namespace TubeRehber.UI.Controllers
{
    public class SporController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            TubeRehber.Model.Entities.Category category = _categoryService.GetCategoryByCategoryName("Spor");
            ...
            TempData["SportsChannelLinks"] = ChannelLinks;
